...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                dcc.Dropdown(id='site-dropdown',placeholder="Select your Launch Site Here",options=[
...
def get_scatter_chart(entered_site,slider_range):
    ...
    if entered_site == 'ALL':
        ...
        title='Scatter for ALL')
        
    else:
         
         df=mask[mask['Launch Site']==entered_site],
         fig = px.scatter(mask, x="Payload Mass (kg)", y="class",color="Booster Version Category",
        title='Scatter for'+str(entered_site))
    return fig 
